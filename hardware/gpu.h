...
#define GPU_DRAWCONFIG_DITHER					0x00400000
#define GPU_DRAWCONFIG_SETMASK					0x00200000
#define GPU_DRAWCONFIG_USEMASK					0x00100000

#define GPU_DRAWCONFIG_BLEND_RESET				0x00000080
#define GPU_DRAWCONFIG_RESET_MASK				0x00000070
#define GPU_DRAWCONFIG_RESET_SHIFT				4

#define GPU_DRAWCONFIG_BLEND_SET				0x00000008
#define GPU_DRAWCONFIG_SET_MASK					0x00000007
#define GPU_DRAWCONFIG_SET_SHIFT				0

enum GPUDrawConfig_Coff {
	GPU_DRAWCONFIG_0_50_POS_0_50 = 0,
	GPU_DRAWCONFIG_0_50_POS_1_00 = 1,
	GPU_DRAWCONFIG_0_50_NEG_1_00 = 2,
	GPU_DRAWCONFIG_0_50_POS_0_25 = 3,
	GPU_DRAWCONFIG_1_00_POS_0_50 = 4,
	GPU_DRAWCONFIG_1_00_POS_1_00 = 5,
	GPU_DRAWCONFIG_1_00_NEG_1_00 = 6,
	GPU_DRAWCONFIG_1_00_POS_0_25 = 7,
};

#define GPU_DRAWCONFIG(a,b)		(GPU_DRAWCONFIG_COMMAND | \
		((a << GPU_DRAWCONFIG_SET_SHIFT) & GPU_DRAWCONFIG_SET_MASK) | \
		((b << GPU_DRAWCONFIG_RESET_SHIFT) & GPU_DRAWCONFIG_RESET_MASK))
...
#define GPU_CR_RX_FULL				0x80000000
#define GPU_CR_TX_EMPTY				0x40000000
#define GPU_CR_BUSY					0x20000000
#define GPU_CR_RESET 				0x10000000

enum GPUCrVideoMode {
	GPU_CR_VIDEOMODE_256_240,
	GPU_CR_VIDEOMODE_320_240,
	GPU_CR_VIDEOMODE_512_240,
	GPU_CR_VIDEOMODE_640_240,
	GPU_CR_VIDEOMODE_256_480,
	GPU_CR_VIDEOMODE_320_480,
	GPU_CR_VIDEOMODE_512_480,
	GPU_CR_VIDEOMODE_640_480
};

#define GPU_CR_VIDEOMODE_MASK		0x00000007
#define GPU_CR_VIDEOMODE_SHIFT		0
