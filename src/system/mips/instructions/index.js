...
class ConstFields {
	...
	// Standard decoding fields
	get opcode() { return [{ op: 'i32.const', value: (this._word >> 26) & 0b111111 }] }
	get funct() { return [{ op: 'i32.const', value: this._word & 0b111111 }] }
	get shamt() { return [{ op: 'i32.const', value: (this._word >> 6) & 0b11111 }] }
	get rd() { return [{ op: 'i32.const', value: (this._word >> 11) & 0b11111 }] }
	get rt() { return [{ op: 'i32.const', value: (this._word >> 16) & 0b11111 }] }
	get rs() { return [{ op: 'i32.const', value: (this._word >> 21) & 0b11111 }] }
	get imm16() { return [{ op: 'i32.const', value: this._word & 0xFFFF }] }
	get simm16() { return [{ op: 'i32.const', value: this._word << 16 >> 16 }] }
	get imm20() { return [{ op: 'i32.const', value: (this._word >> 6) & 0xFFFFF }] }
	get imm25() { return [{ op: 'i32.const', value: this._word & 0x1FFFFFF }] }
	get imm26() { return [{ op: 'i32.const', value: this._word & 0x3FFFFFF }] }
	get cop() { return [{ op: 'i32.const', value: (this._word >>> 26) & 3 }] }
}
