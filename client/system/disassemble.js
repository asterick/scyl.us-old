...
export const instructions = {
	'undefined_op': _ => 'unk',
	'bx': (fields, address) => `bx${fields.cond}\t${fields.Rn}`,
	'blx': (fields, address) => `blx${fields.cond}\t${fields.Rm}`,
	'b': (fields, address) => `b${fields.cond}\t#0x${((fields.imm << 2) + address + 8).toString(16)}`,
	'bl': (fields, address) => `bl${fields.cond}\t#0x${((fields.imm << 2) + address + 8).toString(16)}`,
	'stc': _ => 'failed\tstc',
	'ldc': _ => 'failed\tldc',
	'cdp': _ => 'failed\tcdp',
	'mcr': _ => 'failed\tmcr',
	'mrc': _ => 'failed\tmrc',
	'swi': fields => `swi${fields.cond}\t#0x#${fields.imm}`,
	...
	'swp': fields => `swp${fields.cond}\t${fields.Rd}, ${fields.Rm}, ${Rs}, ${fields.Rn}`,
	'swp': fields => `swp${fields.cond}b\t${fields.Rd}, ${fields.Rm}, ${Rs}, ${fields.Rn}`,
